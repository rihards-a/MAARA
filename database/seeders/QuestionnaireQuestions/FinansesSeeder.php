...
class FinansesSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $questions = [
            ...
            [
                'id'               => 106,
                'text'             => 'Vai Tu esi investējis līdzekļus kādos fondos?',
                'type'             => 'multichoice',
                'questionnaire_id' => $questionnaire->id,
                'updated_at'  => now(),
                'created_at'  => now(),
            ...
            [
                'id'               => 107,
                'text'             => 'Vai Tev pieder kādas  īpaši vērtīgas fiziskas lietas?',
                'type'             => 'boolean',
                'questionnaire_id' => $questionnaire->id,
                'updated_at'  => now(),
                'created_at'  => now(),
            ...
            [
                'id'               => 108,
                'text'             => 'Vai ir kas cits finansiāli vērtīgs, kas Tev pieder un neietilpst nevienā no šīm kategorijām?',
                'type'             => 'boolean',
                'questionnaire_id' => $questionnaire->id,
                'updated_at'  => now(),
                'created_at'  => now(),
