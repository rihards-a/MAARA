...
<head>
    <meta charset="UTF-8">
    <title>MAARA apstiprinājums</title>
</head>
<body style="font-family: Arial, sans-serif; color: #333; line-height: 1.6; background-color: #f9f9f9; padding: 20px;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #fff; border-radius: 8px; padding: 30px; box-shadow: 0 2px 6px rgba(0,0,0,0.05);">
        ...
        <p>
            Ar šo e-pastu apstiprinām, ka ziņosim Tev tiklīdz pēcdzīves plānošanas rīks būs pieejams lietotājiem.
            <br>Paldies, ka esi kopā ar mums!
        </p>
        ...
        <p style="font-size: 0.9em; color: #666;">
            Ja vēlies, lai izņemam Tavu e-pasta adresi no mūsu kontaktu loka, lūdzu, dari mums to zināmu rakstot uz 
            <a href="mailto:info@maara.id.lv">info@maara.id.lv</a>.
        </p>
    </div>
</body>
</html>