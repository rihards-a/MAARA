<nav aria-label="Galvenās sadaļas" class="bg-white sticky top-[40px] z-40">
  <div class="flex flex-wrap justify-center gap-2">
      <a href="{{ route('dashboard') }}"    
        class="flex items-center justify-center flex-shrink-0 px-3 py-2 text-xs font-medium rounded-md shadow-sm text-black bg-white hover:bg-[#76A392] hover:text-white transition-colors duration-150 ease-in-out min-w-[40px] max-w-[40px]"
        aria-label="Mājas">
