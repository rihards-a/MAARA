...
@include('components.mini-tab-navbar')
    ...
    Šajā sadaļā aicinām Tevi uzrakstīt savas vēlmes, ziņas vai domas, ko vēlies nodot saviem tuviniekiem (visiem vai konkrētam cilvēkam) pēc savas nāves. Tie var būt gan nelieli stāstiņi par Tavu dzīvi, gan filozofiskas pārdomas par dzīvi un aiziešanu, gan sirdssilti novēlējumi palicējiem. Šādu ziņu galvenais uzdevums ir sniegt mierinājumu un palīdzēt tuviniekiem ...... [te vajag Artu]
    </p>
    <br>
