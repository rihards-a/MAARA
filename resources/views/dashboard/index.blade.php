      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-4 items-stretch">
        @php
          $guides = [
            ...
            ['title' => 'Finanšu pārvaldība', 'text' => 'Paredzamais sakārtošanas ilgums: 30 minūtes', 'route' => route('dashboard'), 'image' => '/images/house.svg'],
            ['title' => 'Mantojuma un citu juridisku dokumentu sagatavošana', 'text' => 'Paredzamais sakārtošanas ilgums: 60 minūtes', 'route' => route('dashboard'), 'image' => '/images/leaf.svg'],
