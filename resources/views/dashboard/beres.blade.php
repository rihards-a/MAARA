...
@include('components.mini-tab-navbar')
    ...
    <form action="{{ route('dashboard.beres.save') }}" method="POST" class="bg-white shadow-md rounded-lg p-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div>
            ...
            <textarea name="responses[1][response_value]" id="important_details" class="w-full border border-gray-300 rounded-md shadow-sm focus:border-lime-900 focus:ring-lime-900 text-gray-700 text-sm p-9" placeholder="Vissvarīgāk man ir, lai...">{{ $responses[1] ?? '' }}</textarea>
        ...
        <div>
            ...
            <textarea name="responses[2][response_value]" id="not_wanted" class="w-full border border-gray-300 rounded-md shadow-sm focus:border-lime-900 focus:ring-lime-900 text-gray-700 text-sm p-9" placeholder="Es noteikti negribētu, lai...">{{ $responses[2] ?? '' }}</textarea>
        ...
        <div>
            ...
            <select name="responses[3][response_value]" id="burial_preference" class="w-full border border-gray-300 rounded-md shadow-sm focus:border-lime-900 focus:ring-lime-900 text-gray-700 text-sm p-3">
        ...
        <div>
            ...
            <textarea name="responses[4][response_value]" id="resting_place" class="w-full border border-gray-300 rounded-md shadow-sm focus:border-lime-900 focus:ring-lime-900 text-black-700 text-sm p-4" placeholder="Šeit norādi konkrētu atdusas vietu, ja tāda ir (pelnu izkaisīšanas lokāciju vai/un kapsētu)">{{ $responses[4] ?? '' }}</textarea>
        ...
        <div>
            ...
            <textarea name="responses[5][response_value]" id="eulogy" class="w-full border border-gray-300 rounded-md shadow-sm focus:border-lime-900 focus:ring-lime-900 text-black-700 text-sm p-4" placeholder="Vēlamais autors un aptuvenais saturs, ja Tev ir konkrētas vēlmes">{{ $responses[5] ?? '' }}</textarea>
        ...
        <div>
            ...
            <textarea name="responses[6][response_value]" id="music" class="w-full border border-gray-300 rounded-md shadow-sm focus:border-lime-900 focus:ring-lime-900 text-black-700 text-sm p-4" placeholder="Vai ir kāda dziesma, konkrēti mūzikas instrumenti vai žanrs, ko Tu izvēlētos savām bērēm?">{{ $responses[6] ?? '' }}</textarea>
        ...
        <div>
            ...
            <textarea name="responses[7][response_value]" id="farewell_location" class="w-full border border-gray-300 rounded-md shadow-sm focus:border-lime-900 focus:ring-lime-900 text-black-700 text-sm p-4" placeholder=" Bēru ceremonijas norises vieta">{{ $responses[7] ?? '' }}</textarea>
        ...
        <div>
            ...
            <textarea name="responses[8][response_value]" id="overall_mood" class="w-full border border-gray-300 rounded-md shadow-sm focus:border-lime-900 focus:ring-lime-900 text-black-700 text-sm p-4" placeholder="Apraksti sevis iztēloto noskaņu ar īpašības vārdiem (piemēram, ''gaiša'', ''apcerīga'', ''piezemēta'', u.c.)">{{ $responses[8] ?? '' }}</textarea>
        ...
        <div>
            ...
            <textarea name="responses[9][response_value]" id="guests" class="w-full border border-gray-300 rounded-md shadow-sm focus:border-lime-900 focus:ring-lime-900 text-black-700 text-sm p-4" placeholder="Vai vēlies visiem pieejamu vai ļoti privātu atvadīšanos?">{{ $responses[9] ?? '' }}</textarea>
        ...
        <div>
            ...
            <textarea name="responses[10][response_value]" id="ritual_items" class="w-full border border-gray-300 rounded-md shadow-sm focus:border-lime-900 focus:ring-lime-900 text-black-700 text-sm p-4" placeholder=" Apraksti savas vēlmes saistībā ar tradicionālo apbedīšanas priekšmetu noformējumu, ja tādas ir">{{ $responses[10] ?? '' }}</textarea>
        ...
        <div>
            ...
            <textarea name="responses[11][response_value]" id="flowers" class="w-full border border-gray-300 rounded-md shadow-sm focus:border-lime-900 focus:ring-lime-900 text-black-700 text-sm p-4" placeholder="Ja Tev ir ziedu preferences, norādi tās šeit">{{ $responses[11] ?? '' }}</textarea>
        ...
        <div>
            ...
            <textarea name="responses[12][response_value]" id="advisors" class="w-full border border-gray-300 rounded-md shadow-sm focus:border-lime-900 focus:ring-lime-900 text-black-700 text-sm p-4" placeholder="Vai ir kāds tuvinieks(--i), uz kuru izvēlēm un darbībām Tu īpaši paļaujies?">{{ $responses[12] ?? '' }}</textarea>
