<div class="section finanses">
    ...
    <div style="page-break-inside: avoid;">
        ...
        @if (isset($responses[100]) && is_array($responses[100]) && !in_array('none', $responses[100]))
            ...
            @foreach ($responses[100] as $value)
                @if ($value === 'other')
                    <p><x-pdf.to-fill-section title="Informācija par ____________ kontu" height=140/></p>  
                @else
                    <p><x-pdf.to-fill-section title="Informācija par {{ $value }} kontu" height=140/></p>  
                @endif
            @endforeach
        @endif
    </div>
    ...
    <div style="page-break-inside: avoid;">
        ...
        @elseif (isset($responses[102]) && is_array($responses[102]) && in_array('options', $responses[102]))
            <x-pdf.to-fill-section title="Informācija par manām akciju opcijām:" height=140/>
        @endif
    </div>
    ...
    <div style="page-break-inside: avoid;">
        ...
        @if (isset($responses[103]) && is_array($responses[103]) && in_array('yes', $responses[103]))
            <x-pdf.to-fill-section title="Informācija par manām kriptovalūtām:" height=140 />
        @endif
    </div>
    ...
    @if (isset($responses[104]))
        @if (isset($responses[104][0]) && ($responses[104][0] !== null && $responses[104][0] != 0))
            @if ($responses[104][0] == 1)
                <x-pdf.to-fill-section title="Informācija par manu nekustamo īpašumu Latvijā:"height=140 />
            @else
                <x-pdf.to-fill-section title="Informācija par maniem nekustamajiem īpašumiem Latvijā:" height=140/>
            @endif
        @endif

        @if (isset($responses[104][1]) && ($responses[104][1] !== null && $responses[104][1] != 0))
            @if ($responses[104][1] == 1)
                <x-pdf.to-fill-section title="Informācija par manu nekustamo īpašumu ārzemēs:" height=140/>
            @else
                <x-pdf.to-fill-section title="Informācija par maniem nekustamajiem īpašumiem ārzemēs:"height=140 />
            @endif
        @endif
    @endif
    </div>
    ...
    @if (isset($responses[105]))
        @if (isset($responses[105][0]) && ($responses[105][0] !== null && $responses[105][0] != 0))
            @if ($responses[105][0] == 1)
                <x-pdf.to-fill-section title="Informācija par manu transportlīdzekli Latvijā:" height=140 />
            @else
                <x-pdf.to-fill-section title="Informācija par maniem transportlīdzekļiem Latvijā:" height=140/>
            @endif
        @endif

        @if (isset($responses[105][1]) && ($responses[105][1] !== null && $responses[105][1] != 0))
            @if ($responses[105][1] == 1)
                <x-pdf.to-fill-section title="Informācija par manu transportlīdzekli ārzemēs:" height=140 />
            @else
                <x-pdf.to-fill-section title="Informācija par maniem transportlīdzekļiem ārzemēs:" height=140/>
            @endif
        @endif
    @endif
    </div>
    ...
    <div style="page-break-inside: avoid;">
        ...
        @if (!empty(array_filter($responses[106] ?? [])))
            <x-pdf.to-fill-section title="Informācija par maniem līdzekļiem fondos:" height=140/>
        @endif
    </div>
    ...
    <div style="page-break-inside: avoid;">
        ...
        @if (isset($responses[107]) && is_array($responses[107]) && in_array('yes', $responses[107]))
            <x-pdf.to-fill-section title="Informācija par manām īpaši vērtīgajām fiziskajām lietām:" height=140/>
        @endif
    </div>
    ...
    <div style="page-break-inside: avoid;">
        ...
        @if (isset($responses[108]) && is_array($responses[108]) && in_array('yes', $responses[108]))
            <x-pdf.to-fill-section title="Informācija par manām finansiāli vērtīgām lietām, kas neietilpst nevienā no šīm kategorijām:" height=140 />
        @endif
    </div>
</div>
